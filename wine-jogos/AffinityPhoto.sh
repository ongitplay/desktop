...
#~/.jogos/scripts/winetricks -q dotnet20sp2
~/.jogos/scripts/winetricks -q dotnet462
...
cd ~/.jogos/setups/
wget -nc https://www.opencode.net/felipefacundes/free-games/raw/master/affp_demo.tar.xz
rm -rf affp_demo
tar -xf affp_demo.tar.xz
cd affp_demo/
$W/bin/wine affinity-photo-1.7.0.367.exe
